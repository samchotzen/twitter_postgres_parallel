...
![](https://github.com/samchotzen/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/samchotzen/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/samchotzen/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/samchotzen/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/samchotzen/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/samchotzen/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 7:57.60elapsed            | 0:47.38elapsed            | 
| `pg_normalized_batch`  | 2:35.47elapsed            | 0:13.99elapsed            | 
| `pg_denormalized`      | 0:20.70elapsed            | 0:03.90elapsed            | 
